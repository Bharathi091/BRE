sap.ui.define([
	...
	"use strict";
	var instance;
	var LineItemsServices = Object.extend("dbedit.Services.LineItemsServices", {
		...
		getLineItemsData: function(BillEditModel, vblen, that) {
			...
			oModel1.read("/BillSummarySet('" + vblen + "')/OrderItemSet", {
		...
		getWFComments: function(BillEditModel, billModel, that) {
			var deferred = $.Deferred();
			var service = BillEditModel.getProperty("/Inputs");
			var userServiceUrl = that.getOwnerComponent().getModel().sServiceUrl;
